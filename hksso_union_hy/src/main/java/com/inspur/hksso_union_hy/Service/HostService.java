...
import com.inspur.hksso_union_hy.Mapper.HostMapper;
...
//        hostMapper.SaveNetWorkSwitchHistory(data);
    ...
    public void SaveHostData(Map<String,Object> data){
        ...
        hostMapper.SaveHostDataHistory(data);
    }
